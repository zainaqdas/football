...
import 'piccolore';
import { k as renderTemplate, h as addAttribute, m as maybeRenderHead, o as renderComponent, p as Fragment } from './entrypoint_DlJc2ilo.mjs';
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('[id^="player-"][data-proxied-url]').forEach(function (container) {
      ...
      function showControls() {
        ...
        // Only show center play if paused
        if (!isPlaying) {
      ...
      function initPlayer(url) {
        if (window.Hls && window.Hls.isSupported()) {
          ...
          controls.loadingSpinner.classList.add('hidden');
          controls.errorOverlay.querySelector('p').textContent = 'Este navegador no soporta HLS.';
          controls.errorOverlay.classList.remove('hidden');
        }
      }
